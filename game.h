...
typedef enum {
  ...
  VOUCHER_CLEARANCE_SALE = 1u << 1,
  VOUCHER_HONE = 1u << 2,
  VOUCHER_REROLL_SURPLUS = 1u << 3,
  VOUCHER_CRYSTAL_BALL = 1u << 4,
  VOUCHER_TELESCOPE = 1u << 5,
  VOUCHER_GRABBER = 1u << 6,
  VOUCHER_WASTEFUL = 1u << 7,
  VOUCHER_TAROT_MERCHANT = 1u << 8,
  VOUCHER_PLANET_MERCHANT = 1u << 9,
  VOUCHER_SEED_MONEY = 1u << 10,
  VOUCHER_BLANK = 1u << 11,
  VOUCHER_MAGIC_TRICK = 1u << 12,
  VOUCHER_HIEROGLYPH = 1u << 13,
  VOUCHER_DIRECTORS_CUT = 1u << 14,
  VOUCHER_PAINT_BRUSH = 1u << 15,

  // Upgraded vouchers
  VOUCHER_OVERSTOCK_PLUS = 1u << (0 + 16),
  VOUCHER_LIQUIDATION = 1u << (1 + 16),
  VOUCHER_GLOW_UP = 1u << (2 + 16),
  VOUCHER_REROLL_GLUT = 1u << (3 + 16),
  VOUCHER_OMEN_GLOBE = 1u << (4 + 16),
  VOUCHER_OBSERVATORY = 1u << (5 + 16),
  VOUCHER_NACHO_TONG = 1u << (6 + 16),
  VOUCHER_RECYCLOMANCY = 1u << (7 + 16),
  VOUCHER_TAROT_TYCOON = 1u << (8 + 16),
  VOUCHER_PLANET_TYCOON = 1u << (9 + 16),
  VOUCHER_MONEY_TREE = 1u << (10 + 16),
  VOUCHER_ANTIMATTER = 1u << (11 + 16),
  VOUCHER_ILLUSION = 1u << (12 + 16),
  VOUCHER_PTEROGLYPH = 1u << (13 + 16),
  VOUCHER_RETCON = 1u << (14 + 16),
